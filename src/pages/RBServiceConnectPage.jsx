...
const serviceConnectSite = "https://rbserviceconnect.vercel.app";
      ...
      <section className="relative isolate overflow-hidden bg-[#0f172a] text-white">
        ...
        <div className="mx-auto grid min-h-[620px] max-w-[1680px] items-center gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[.9fr_1.1fr] lg:px-12 xl:px-16">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .6 }}>
            ...
            <div className="mt-9 flex flex-wrap gap-3"><a href={serviceConnectSite} target="_blank" rel="noreferrer" className="group inline-flex items-center gap-3 bg-[#10b981] px-6 py-4 text-sm font-bold uppercase tracking-[.08em] text-[#06291f] transition hover:-translate-y-0.5 hover:bg-[#34d399]">Visit RB Service Connect <span className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1">↗</span></a><Link to="/companies" className="inline-flex items-center bg-white px-6 py-4 text-sm font-bold uppercase tracking-[.08em] text-[#0f172a] transition hover:-translate-y-0.5 hover:bg-[#d1fae5]">Back to portfolio</Link><Link to="/contact" className="inline-flex items-center border border-white/20 px-6 py-4 text-sm font-bold uppercase tracking-[.08em] text-white transition hover:bg-white/10">Connect with RB Corp</Link></div>
          </motion.div>
