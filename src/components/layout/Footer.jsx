...
function FooterLink({ to, children }) {
  return (
    <Link
      to={to}
      className="group inline-flex w-fit items-center gap-2 rounded-sm transition duration-300 hover:translate-x-1 hover:text-[#ff6b6e] focus-visible:translate-x-1 focus-visible:text-[#ff6b6e] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff4d50]/40"
    >
      <span aria-hidden="true" className="h-px w-0 bg-[#ff4d50] transition-all duration-300 group-hover:w-4 group-focus-visible:w-4" />
      {children}
    </Link>
  );
}
      ...
      <div className="mx-auto max-w-[1680px] px-5 py-16 sm:px-8 lg:px-12 xl:px-16 lg:py-20">
        <div className="grid gap-12 border-b border-white/10 pb-14 lg:grid-cols-[1.35fr_.75fr_.75fr_.75fr]">
          <div>
            <Link
              to="/"
              className="group flex w-fit items-center gap-4 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff4d50]/40 focus-visible:ring-offset-4 focus-visible:ring-offset-[#0b0b0c]"
            ...
            >
              <div className="h-24 w-28 overflow-hidden">
                <img
                  ...
                  loading="lazy"
                  decoding="async"
                  className="h-full w-full object-contain mix-blend-screen transition duration-300 group-hover:scale-[1.04] group-focus-visible:scale-[1.04]"
                />
              </div>
              <div>
                <p className="text-xs font-bold uppercase tracking-[0.18em] transition group-hover:text-[#ff6b6e] group-focus-visible:text-[#ff6b6e]">Royalties Beauty Corp</p>
        ...
        <div className="flex flex-col gap-5 pt-6 text-xs text-white/34 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-2">
            <Link to="/privacy" className="rounded-sm transition hover:text-[#ff6b6e] focus-visible:text-[#ff6b6e] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff4d50]/40">Privacy</Link>
            <Link to="/terms" className="rounded-sm transition hover:text-[#ff6b6e] focus-visible:text-[#ff6b6e] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff4d50]/40">Terms</Link>
            <Link to="/disclaimer" className="rounded-sm transition hover:text-[#ff6b6e] focus-visible:text-[#ff6b6e] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff4d50]/40">Disclaimer</Link>
          </div>
